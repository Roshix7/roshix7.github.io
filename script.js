    ...
    if (project) {
        ...
        if (project.travailIndividuel && project.travailIndividuel.trim() !== '') {
            ...
            if (individualWorkTitleElement) {
                individualWorkTitleElement.style.display = 'block';
            }
            individualWorkTextElement.style.display = 'block';
        } else {
            individualWorkTextElement.textContent = '';
            if (individualWorkTitleElement) {
                individualWorkTitleElement.style.display = 'none'; 
            }
            individualWorkTextElement.style.display = 'none'; 
        }
        ...
        if (project.techniquesAcquises && project.techniquesAcquises.length > 0) {
            ...
            if (techniquesTitleElement) {
                techniquesTitleElement.style.display = 'block'; 
            }
            techniquesListElement.style.display = 'block'; 
        } else {
            techniquesListElement.innerHTML = '';
            if (techniquesTitleElement) {
                techniquesTitleElement.style.display = 'none';
            }
            techniquesListElement.style.display = 'none'; 
        }
